...
export const Second: FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg width="37" height="37" className='w-[4.5vw] h-[4.5vw] sm:w-[3.5vw] sm:h-[3.5vw] md:w-[3vw] md:h-[3vw] lg:w-[2.5vw] lg:h-[2.5vw] xl:w-[2vw] xl:h-[2vw] 2xl:w-[1.5vw] 2xl:h-[1.5vw]' viewBox="0 0 37 37" fill="none" {...props}>
    <path
      ...
      fill="currentColor"
      className="text-black dark:text-text-1-dark"
    />
  </svg>
);
